const GAMES = [
  ...
  },
  {
    ...
    desc: 'Динамічна гра на реакцію: влучай у мішені, що рухаються по екрану. Заробляй очки за точні попадання та уникай промахів. Вибирай рівень складності та швидкість руху мішеней. Гра тренує швидкість реакції, точність та концентрацію уваги.',
